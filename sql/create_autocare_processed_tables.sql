...
-- Staging tables removed. AutoCare sync now uses stripe-customers endpoint (~11k records)
-- with full refresh (TRUNCATE + INSERT) into processed tables; no staging.
-- If upgrading from a previous deployment that had staging tables, run:
